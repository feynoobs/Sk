...
class _HomeTimelineState extends State<HomeTimeline>
{
    ...
    Widget _memuItem(int id, int myUserId, Map<String, dynamic> jsonObject)
    {
        return Card(
            child: Column(
                children: <Widget>[
                            ...
                            Column(
                                children: <Widget>[
                                    RichText(
                                        ...
                                        text: TextSpan(
                                            children: <InlineSpan>[
                                                TextSpan(text: jsonObject['name']),
                                                TextSpan(text: '@' + jsonObject['screen_name'], style: const TextStyle(fontStyle: FontStyle.italic))
                                            ],
                                        )
                                    ),
                                    Text(jsonObject['created_at'])
                                ]
                            )
                        ]
                    )
